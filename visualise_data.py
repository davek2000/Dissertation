...
class Sequence(Slicer):
    ...
    def iterate_all(self):
        ...
        for lower, upper in zip(start, end):
            ...
            # No acceleration.csv
            #yield lu, (pir_df.copy(),video_living_room,video_kitchen,video_hallway)

            # No pir.csv
            #yield lu, (acceleration,rssi,video_living_room,video_kitchen,video_hallway)

            # No video_*.csv
            #yield lu, (acceleration, rssi,pir_df.copy())

    def iterate_no_acceleration(self):
        start = range(int(self.meta['end']) + 1)
        end = range(1, int(self.meta['end']) + 2)
    ...
    def iterate_acceleration_only(self):
        start = range(int(self.meta['end']) + 1)
        end = range(1, int(self.meta['end']) + 2)
        ...
        for lower, upper in zip(start, end):
            ...
            # No pir.csv & No video_*.csv
            yield lu, (acceleration, rssi)

    def iterate_pir_only(self):
        start = range(int(self.meta['end']) + 1)
        end = range(1, int(self.meta['end']) + 2)
        ...
        for lower, upper in zip(start, end):
            ...
            # No acceleartion.csv & no video_*.csv
            yield lu, (pir_df.copy())



    def iterate_video_only(self):
        start = range(int(self.meta['end']) + 1)
        end = range(1, int(self.meta['end']) + 2)
        ...
        for lower, upper in zip(start, end):
            ...
            # No acceleration.csv & No pir.csv
            yield lu, (video_living_room,video_kitchen,video_hallway)
